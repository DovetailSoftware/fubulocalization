...
task :compile => [:clean, :version] do
  sh "#{msbuild} src/FubuLocalization.sln /property:Configuration=#{COMPILE_TARGET} /v:m /t:rebuild /nr:False /maxcpucount:8"
end
...
task :fast_test do
  sh "src/packages/NUnit.ConsoleRunner.3.6.1/tools/nunit3-console.exe src/FubuLocalization.Tests/bin/#{COMPILE_TARGET}/FubuLocalization.Tests.dll"
end